...
if __name__ == "__main__":
    ...
    registered = point_to_point_icp(source, target, threshold, trans_init)
    evaluation = o3d.pipelines.registration.evaluate_registration(
        registered, target, threshold, trans_init)
    print(evaluation, "\n")

    registered = point_to_plane_icp(source, target, threshold, trans_init)
    evaluation = o3d.pipelines.registration.evaluate_registration(
        registered, target, threshold, trans_init)
    print(evaluation, "\n")